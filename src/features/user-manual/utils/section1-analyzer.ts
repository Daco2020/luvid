...
export function generateRechargeInsight(
  ...
  const insights: Record<string, Insight> = {
    solitude: {
      ...
      teaserHint: "혼자만의 시간이 필요한 타입이시군요... 🤔",
    },
    social: {
      ...
      teaserHint: "사람들과 함께 있을 때 빛나는 타입이네요... ✨",
    },
    close_friends: {
      ...
      teaserHint: "소수 정예와의 깊은 대화를 선호하시는군요... 💬",
    },
    activity: {
      ...
      teaserHint: "몸을 움직여야 에너지가 충전되는 타입이네요... 🏃",
    },
  };
...
export function generateUncertaintyInsight(
  ...
  const insights: Record<string, Insight> = {
    low: {
      ...
      teaserHint: "답장이 늦으면 불안해지는 타입이시군요... 😟",
    },
    high: {
    ...
    medium: {
      ...
      teaserHint: "상황에 따라 불안도가 달라지는 타입이네요... 🤔",
    },
  };
...
export function generateConflictInsight(resolution: string): Insight {
  const insights: Record<string, Insight> = {
    quick_fix: {
      ...
      teaserHint: "갈등이 생기면 빨리 풀고 싶어하는 타입이시군요... 😅",
    },
    time_needed: {
      ...
      teaserHint: "갈등 후 생각할 시간이 필요한 타입이네요... ⏳",
    },
    indirect: {
      ...
      teaserHint: "직접적인 사과보다 행동으로 보여주는 타입이시군요... 🤔",
    },
    standoff: {
