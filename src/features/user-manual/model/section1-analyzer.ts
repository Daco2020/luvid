...
export const BASELINE_INSIGHTS: Record<string, Insight> = {
  independent: { // Previously Solitude
    title: "홀로서기 가능한 독립형",
    description: "혼자만의 시간과 자율성이 보장될 때 가장 안정감을 느껴요. 방해받지 않는 환경을 선호합니다.",
